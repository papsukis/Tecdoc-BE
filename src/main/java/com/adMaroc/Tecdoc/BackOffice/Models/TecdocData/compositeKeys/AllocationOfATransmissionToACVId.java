...
@Embeddable
public class AllocationOfATransmissionToACVId implements Serializable {
    ...
    public AllocationOfATransmissionToACVId() {
    }

    public AllocationOfATransmissionToACVId(long nTypNr, long nTypSubNr, long lfdNr) {
        this.nTypNr = nTypNr;
    ...
    public boolean equals(Object o) {
        ...
        AllocationOfATransmissionToACVId that = (AllocationOfATransmissionToACVId) o;
