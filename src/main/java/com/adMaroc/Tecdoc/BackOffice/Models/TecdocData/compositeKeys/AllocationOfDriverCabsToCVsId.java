...
public class AllocationOfDriverCabsToCVsId implements Serializable {
    ...
    public AllocationOfDriverCabsToCVsId() {
    }

    public AllocationOfDriverCabsToCVsId(long nTypNr, long nTypSubNr, long lfdNr) {
        this.nTypNr = nTypNr;
    ...
    public boolean equals(Object o) {
        ...
        AllocationOfDriverCabsToCVsId that = (AllocationOfDriverCabsToCVsId) o;
